...
void Entity::Update()
{
	std::vector<Updatable*> updatables = GetAllComponents<Updatable>();
...
{
	std::vector<FixedUpdatable*> fixedUpdatables = GetAllComponents<FixedUpdatable>();
...
{
	std::vector<Drawable*> drawables = GetAllComponents<Drawable>();
