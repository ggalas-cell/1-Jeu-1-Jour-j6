...
void Win_Scene::OnEnter()
{
    sf::Font& font = GameManager::Get()->GetFont();

    m_winText.setFont(font);
    m_winText.setString("Felicitations !");
    m_winText.setCharacterSize(80);
    m_winText.setFillColor(sf::Color(50, 200, 100));
    ...
    m_subText.setString("Vous avez termine tous les niveaux !\n\n      Appuyez sur R pour rejouer");
...
void Win_Scene::OnDraw(sf::RenderWindow* _window)
{
